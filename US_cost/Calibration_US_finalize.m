...
theta = parameters_US_f(2);
sigma = parameters_US_f(3);
B = parameters_US_f(4);
cost = 0.0202;
IF = 0.0073;
mu_d = 0.0180 + IF; 
...
%% Save Parameters
parameters_US_final_f=[sigma,B,nb,alpha1,alpha2,alpha3,beta,cost,eta,A,theta];
save parameters_US_final_f.mat parameters_US_final_f Data_TT