...
%% Build Dataset
Data_TT = synchronize(Deposit_Annual,Loan_Annual,Inflation_Annual,Yield_Annual,M1GDP,'intersection');
save Calibration_US_f.mat Data_TT
first_year = 2000;
last_year = 2012;
...
parameters_US_f = importdata('output.txt');
save Calibration_US_f.mat parameters_US_f Data_TT eta