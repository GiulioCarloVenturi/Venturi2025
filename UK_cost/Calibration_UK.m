...
MRR_rate = readtimetable("Data_Calibration_UK.xlsx", "UseExcel", false,Sheet="Bank Rate");
...
save Calibration_UK_f.mat Data_TT
first_year = 2000;
last_year = 2012;
...
parameters_UK_f = importdata('output.txt');
save Calibration_UK_f.mat parameters_UK_f Data_TT eta rq_ratio