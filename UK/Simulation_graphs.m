...
print('UK_deprate','-dpdf','-r200','-fillpage')
% Deposits
f = figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_deposit','-dpdf','-r200','-fillpage')
% Loan Rate
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_loanrate','-dpdf','-r200','-fillpage')
% Loans
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_loan','-dpdf','-r200','-fillpage')
% Loan-Deposit Spread
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_spread','-dpdf','-r200','-fillpage')
% Output
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_GDP','-dpdf','-r200','-fillpage')
%%
% No fees
...
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('1.28% (0.33% merchant fee) fee on deposits, 1.80% fee on cash, 0.434-% fee on CBDC');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
