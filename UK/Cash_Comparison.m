...
epsilon=0.001;
opt = 1;
fees = [0.0180,0.0095,0.0033,0.00434]; % Cash, card, IF, CBDC
mu_c = fees(1);
mu_d = fees(2)+fees(3);
mu_db = fees(3);
mu_cb = fees(4);
...
alpha1_grid = linspace(parameters_UK_final_f(4)/2,parameters_UK_final_f(4),5);
for n = 1:size(alpha1_grid,2)
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp(['Cash Reduction ' num2str((alpha1_grid(end)-alpha1_grid(n))*100) 'pp']);
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
alpha1=alpha1_grid(n);
alpha2=parameters_UK_final_f(5)+(alpha1_grid(end)-alpha1_grid(n));
...
print('UK_cashcomp_rate','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_cashcomp_loan','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_cashcomp_output','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_cashcomp_deposits','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_cashcomp_deprate','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_cashcomp_loans','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_cashcomp_loanrate','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_cashcomp_spread','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('UK_cashcomp_gdp','-dpdf','-r200','-fillpage')