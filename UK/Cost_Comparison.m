...
epsilon=0.001;
opt = 1;
fees = [0.0180,0.0095,0.0033,0.00434]; % Cash, card, merchant fee
...
r = 1/beta - 1;
%% Inflation Rate
pi_m = (prod(1+Data_TT.Inflation(left:right)))^(1/right) - 1; 
...
print('UK_costcomp_rate','-dpdf','-r200','-fillpage')
...
xlabel('CBDC cost','Interpreter','latex','FontSize',15)
print('UK_costcomp_loan','-dpdf','-r200','-fillpage')
...
xlabel('CBDC cost','Interpreter','latex','FontSize',15)
print('UK_costcomp_output','-dpdf','-r200','-fillpage')
