...
rq_ratio = 0.01; 
opt = 1;
fees = [0.0184,0.0123,0.0035,0.0095]; % Cash, card, fee, debit
%% ECB average deposit rate betweem 2000 and 2008
...
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('1.58% (0.35% merchant fee) deposit cost, 1.84% cash cost, 0.95% CBDC cost');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
