...
i_m = 1/beta*(1+pi_m)-1;
trade_prob = parameters_ITA_f(end);
alpha1 = alpha1*trade_prob;
alpha2 = alpha2*trade_prob;
alpha3 = alpha3*trade_prob;
theta = parameters_ITA_f(2);
sigma = parameters_ITA_f(3);
B = parameters_ITA_f(4);
fee = 0.0035;
mu_d = 0.0123 + fee; 
mu_c = 0.0184; 
mu_db = fee;
...
%% Save Parameters
parameters_ITA_final_f=[sigma,B,nb,alpha1,alpha2,alpha3,beta,cost,eta,A,theta];
save parameters_ITA_final_f.mat parameters_ITA_final_f Data_TT