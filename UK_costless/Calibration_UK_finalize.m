...
trade_prob = parameters_UK_nf(end);
alpha1 = alpha1*trade_prob;
alpha2 = alpha2*trade_prob;
alpha3 = alpha3*trade_prob;
theta = parameters_UK_nf(2);
sigma = parameters_UK_nf(3);
B = parameters_UK_nf(4);
mu_d = 0.00;
...
%% Save Parameters
parameters_UK_final_nf=[sigma,B,nb,alpha1,alpha2,alpha3,beta,cost,eta,A,theta];
save parameters_UK_final_nf.mat parameters_UK_final_nf Data_TT rq_ratio