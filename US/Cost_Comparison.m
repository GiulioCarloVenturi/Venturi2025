...
load parameters_US_final_f.mat;

sigma=parameters_US_final_f(1);
B=parameters_US_final_f(2);
Nb = parameters_US_final_f(3);
alpha1=parameters_US_final_f(4);
alpha2=parameters_US_final_f(5);
alpha3=parameters_US_final_f(6);
beta=parameters_US_final_f(7);
cost=parameters_US_final_f(8);
eta=parameters_US_final_f(9);                                   
A=parameters_US_final_f(10); 
theta=parameters_US_final_f(11);
epsilon=0.001;
rq_ratio = 0.0560; 
opt = 1;
fees = [0.0470,0.0180,0.0073,0.0130]; % Cash, card, IF, CBDC
i_reserve = 0.0102; 
mu_c = fees(1);
mu_d = fees(2)+fees(3);
mu_db = fees(3);
...
print('US_costcomp_rate','-dpdf','-r200','-fillpage')
...
xlabel('CBDC cost','Interpreter','latex','FontSize',15)
print('US_costcomp_loan','-dpdf','-r200','-fillpage')
...
xlabel('CBDC cost','Interpreter','latex','FontSize',15)
print('US_costcomp_output','-dpdf','-r200','-fillpage')
