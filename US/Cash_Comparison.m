...
alpha1_grid = linspace(parameters_US_final_f(4)/2,parameters_US_final_f(4),5);
for n = 1:size(alpha1_grid,2)
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp(['Cash Reduction ' num2str((alpha1_grid(end)-alpha1_grid(n))*100) 'pp']);
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
alpha1=alpha1_grid(n);
alpha2=parameters_US_final_f(5)+(alpha1_grid(end)-alpha1_grid(n));
...
print('US_cashcomp_rate','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('US_cashcomp_loan','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('US_cashcomp_output','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('US_cashcomp_deposits','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('US_cashcomp_deprate','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('US_cashcomp_loans','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('US_cashcomp_loanrate','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('US_cashcomp_spread','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('US_cashcomp_gdp','-dpdf','-r200','-fillpage')