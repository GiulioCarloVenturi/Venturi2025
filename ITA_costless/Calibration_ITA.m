...
%% Import Data
Deposit = readtimetable("Data_Calibration_ITA.xlsx", "UseExcel", false,Sheet="Deposit Rate");
Loan = readtimetable("Data_Calibration_ITA.xlsx", "UseExcel", false,Sheet="Loan Rate");
Inflation = readtimetable("Data_Calibration_ITA.xlsx", "UseExcel", false,Sheet="Inflation");
M1 = readtimetable("Data_Calibration_ITA.xlsx", "UseExcel", false,Sheet="M1");
GDP = readtimetable("Data_Calibration_ITA.xlsx", "UseExcel", false,Sheet="GDP");
Yield = readtimetable("Data_Calibration_ITA.xlsx", "UseExcel", false,Sheet="Yield3M");
MRR_rate = fillmissing(readtimetable("Data_Calibration_ITA.xlsx", "UseExcel", false,Sheet="MRR"),'previous');
...
%save Calibration_ITA_nf.mat Data_TT
first_year = 2000;
last_year = 2012;
...
data = [Data_TT.Yield3M/100,Data_TT.M1GDP,Time,Data_TT.DepositRate/100,Data_TT.LoanRate/100,Data_TT.Inflation/100];
...
parameters_ITA_nf = [pars,output,tradep];

save Calibration_ITA_nf.mat parameters_ITA_nf Data_TT