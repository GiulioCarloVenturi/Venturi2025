...
alpha1_grid = linspace(parameters_ITA_final_f(4)/2,parameters_ITA_final_f(4),5);
for n = 1:size(alpha1_grid,2)
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp(['Cash Reduction ' num2str((alpha1_grid(end)-alpha1_grid(n))*100) 'pp']);
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
alpha1=alpha1_grid(n);
alpha2=parameters_ITA_final_f(5)+(alpha1_grid(end)-alpha1_grid(n));
...
print('ITA_cashcomp_rate','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('ITA_cashcomp_loan','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('ITA_cashcomp_output','-dpdf','-r200','-fillpage')
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('ITA_cashcomp_deposits','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('ITA_cashcomp_deprate','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('ITA_cashcomp_loans','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('ITA_cashcomp_loanrate','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('ITA_cashcomp_spread','-dpdf','-r200','-fillpage')
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('ITA_cashcomp_gdp','-dpdf','-r200','-fillpage')

alpha2_grid = parameters_ITA_final_f(5) + (alpha1_grid(end) - alpha1_grid);
Z1 = lambda_func(min((1-mu_d)*deposit+(1-mu_cb)*cbdc,p_star));
Z12 = alpha2_grid.*Z1;
Z2 = alpha3*lambda_func(min((1-mu_c)*cash+(1-mu_d)*deposit+(1-mu_cb)*cbdc,p_star));
Z3 = Z1+Z12;
Z4=interp1(ygrid(:,1),ygrid(:,4),deposit./(1+deposit_rate));
Z5 = deposit./(1+deposit_rate).*Z4;
(1-mu_d)*deposit(1,:)./alpha2_grid