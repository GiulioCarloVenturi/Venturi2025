...
print('GER_welfare_entre','-dpdf','-r200','-fillpage')
% Bankers
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('GER_welfare_banker','-dpdf','-r200','-fillpage')
% Households
f=figure;
hold on
plot(icbdc_grid*100,seller_nofee+buyer_nofee-1,'k','linewidth',4)
plot(icbdc_grid*100,seller_fee+buyer_fee-1,'r','linewidth',4)
xlabel('$i_{CBDC}$','interpreter','latex',FontSize=20)
xlim([0,3])
xtickformat("percentage")
ax=gca;
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('GER_welfare_hh','-dpdf','-r200','-fillpage')