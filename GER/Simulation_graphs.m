...
print('GER_deprate','-dpdf','-r200','-fillpage')
% Deposits
f = figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('GER_deposit','-dpdf','-r200','-fillpage')
% Loan Rate
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('GER_loanrate','-dpdf','-r200','-fillpage')
% Loans
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('GER_loan','-dpdf','-r200','-fillpage')
% Loan-Deposit Spread
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('GER_spread','-dpdf','-r200','-fillpage')
% Output
f=figure;
hold on
...
set(f,'PaperType','A4');
set(f,"PaperOrientation","landscape")
print('GER_GDP','-dpdf','-r200','-fillpage')
%%
% No fees
...
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('1.29% (0.37% merchant fee) fee on deposits, 1.78% fee on cash, 0.43% fee on CBDC');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
