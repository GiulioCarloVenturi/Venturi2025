...
print('GER_costcomp_rate','-dpdf','-r200','-fillpage')
...
xlabel('CBDC cost','Interpreter','latex','FontSize',15)
print('GER_costcomp_loan','-dpdf','-r200','-fillpage')
...
xlabel('CBDC cost','Interpreter','latex','FontSize',15)
print('GER_costcomp_output','-dpdf','-r200','-fillpage')
